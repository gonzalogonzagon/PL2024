...
public class GrammarParser extends Parser {
	...
	public final SentContext sent(Variables var,Bloque b,String func,int ind) throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				setState(178);
				match(T__2);
				String sent = "while(" + ((SentContext)_localctx).lcond.s + ")do"; b.anadirSentencia(new Sentencia(sent, ind)); b.anadirSentencia(new Sentencia("begin", ind)); Bloque nuevoBl = new Bloque();
				setState(180);
			...
			case 8:
				...
				setState(185);
				blq(null, nuevoBl, null, ind + 1);
				sent = nuevoBl.imprimirBloque(); b.anadirSentencia(new Sentencia(sent, ind));
				setState(187);
				match(T__16);
				setState(188);
				match(T__1);
				...
				setState(190);
				match(T__2);
				sent = "until(" + ((SentContext)_localctx).lcond.s + ");"; b.anadirSentencia(new Sentencia(sent, ind));
				}
				break;
			case 9:
				...
				match(T__10);
				setState(203);
				((SentContext)_localctx).ex2 = exp();
				setState(204);
				match(T__2);

				        String mod = ((SentContext)_localctx).ex2.s;
				        String[] partes = mod.split(" ");
				        String sent;
				        if(partes[2].equals("1")){ //Incremento o decremento unitario
				            sent = "for " + (((SentContext)_localctx).id1!=null?((SentContext)_localctx).id1.getText():null) + " := " + ((SentContext)_localctx).ex1.s;
				            if(partes[1].equals("+")){
				                sent += " to ";
				            }else{
				                sent += " downto ";
				            }
				            String[] condiciones = ((SentContext)_localctx).lcond.s.split(" ");
				            sent += condiciones[2];
				            sent += " do";
				            b.anadirSentencia(new Sentencia(sent, ind));
				            b.anadirSentencia(new Sentencia("begin", ind));
				        }else{
				            sent = (((SentContext)_localctx).id1!=null?((SentContext)_localctx).id1.getText():null) + " := " + ((SentContext)_localctx).ex1.s;
				            b.anadirSentencia(new Sentencia(sent, ind));
				            sent = "while(" + ((SentContext)_localctx).lcond.s + ")do";
				            b.anadirSentencia(new Sentencia(sent, ind));
				            b.anadirSentencia(new Sentencia("begin", ind));
				        }
				...
				blq(var, nuevoBl, null, ind + 1);
				        ...
				        if(!partes[2].equals("1")){
				            nuevoBl.anadirSentencia(new Sentencia((((SentContext)_localctx).id2!=null?((SentContext)_localctx).id2.getText():null) + " := " + ((SentContext)_localctx).ex2.s, ind));
				        }
	...
	public static class LcondContext extends ParserRuleContext {
		...
		public Cond2TypesContext c1;
		public OplContext opl;
		public Cond2TypesContext c2;
	...
	public final LcondContext lcond() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(282);
				((LcondContext)_localctx).c1 = cond2Types();
				((LcondContext)_localctx).s =  ((LcondContext)_localctx).c1.s + " ";
				setState(284);
				((LcondContext)_localctx).opl = opl();
				setState(285);
				((LcondContext)_localctx).c2 = cond2Types();
				setState(286);
				((LcondContext)_localctx).lcondd = lcondd();
				_localctx.s += ((LcondContext)_localctx).opl.s + " " + ((LcondContext)_localctx).c2.s + ((LcondContext)_localctx).lcondd.s;
				}
				break;
			}
		}
	...
	public final CondContext cond() throws RecognitionException {
		...
		try {
			...
			((CondContext)_localctx).s =  ((CondContext)_localctx).e1.s + " " + ((CondContext)_localctx).opr.s + " " + ((CondContext)_localctx).e2.s;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
