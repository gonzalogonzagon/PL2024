	...
	public final SentContext sent(Variables var,Bloque b,String func) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				setState(167);
				match(T__2);
				String sent = "if(" + ((SentContext)_localctx).lcond.s + ") then"; b.anadirSentencia(new Sentencia(sent, inden)); b.anadirSentencia(new Sentencia("begin", inden)); inden += 1;
				setState(169);
				...
				setState(173);
				blq(var, bloqueAux, null);
				b.anadirSentencia(new Sentencia("else", inden)); inden += 1; b.anadirSentencia(new Sentencia("begin", inden));
				    sent = bloqueAux.imprimirBloque(); b.anadirSentencia(new Sentencia(sent, inden)); inden -= 1; b.anadirSentencia(new Sentencia("end;", 0));
				}
				break;
			case 7:
