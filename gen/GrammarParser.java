	...
	public final SentContext sent(Variables var,Bloque b,String func) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				setState(167);
				match(T__2);
				String sent = "if(" + ((SentContext)_localctx).lcond.s + ") then"; b.anadirSentencia(new Sentencia(sent, inden)); b.anadirSentencia(new Sentencia("begin", inden));
				setState(169);
				...
				setState(172);
				match(T__13);
				b.anadirSentencia(new Sentencia("else", inden)); b.anadirSentencia(new Sentencia("begin", inden)); 
				setState(174);
				blq(var, bloqueAux, null);
